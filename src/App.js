      ...
      <ScrollToTop>
        ...
        >
          <Routes>
            ...
            <Route path={process.env.PUBLIC_URL + '/home-fashion-three'} element={<HomeFashionThree />} />
            <Route path={process.env.PUBLIC_URL + '/home-fashion-four'} element={<HomeFashionFour />} />
            <Route path={process.env.PUBLIC_URL + '/home-fashion-five'} element={<HomeFashionFive />} />
            <Route path={process.env.PUBLIC_URL + '/home-fashion-six'} element={<HomeFashionSix />} />
            <Route path={process.env.PUBLIC_URL + '/home-fashion-seven'} element={<HomeFashionSeven />} />
            <Route path={process.env.PUBLIC_URL + '/home-fashion-eight'} element={<HomeFashionEight />} />
            <Route path={process.env.PUBLIC_URL + '/home-kids-fashion'} element={<HomeKidsFashion />} />
            <Route path={process.env.PUBLIC_URL + '/home-cosmetics'} element={<HomeCosmetics />} />
            <Route path={process.env.PUBLIC_URL + '/home-furniture'} element={<HomeFurniture />} />
            <Route path={process.env.PUBLIC_URL + '/home-furniture-two'} element={<HomeFurnitureTwo />} />
            <Route path={process.env.PUBLIC_URL + '/home-furniture-three'} element={<HomeFurnitureThree />} />
            <Route path={process.env.PUBLIC_URL + '/home-furniture-four'} element={<HomeFurnitureFour />} />
            <Route path={process.env.PUBLIC_URL + '/home-furniture-five'} element={<HomeFurnitureFive />} />
            <Route path={process.env.PUBLIC_URL + '/home-furniture-six'} element={<HomeFurnitureSix />} />
            <Route path={process.env.PUBLIC_URL + '/home-furniture-seven'} element={<HomeFurnitureSeven />} />
            <Route path={process.env.PUBLIC_URL + '/home-electronics'} element={<HomeElectronics />} />
            <Route path={process.env.PUBLIC_URL + '/home-electronics-two'} element={<HomeElectronicsTwo />} />
            <Route
              path={process.env.PUBLIC_URL + '/home-electronics-three'}
              element={<HomeElectronicsThree />}
            />
            <Route path={process.env.PUBLIC_URL + '/home-book-store'} element={<HomeBookStore />} />
            <Route path={process.env.PUBLIC_URL + '/home-book-store-two'} element={<HomeBookStoreTwo />} />
            <Route path={process.env.PUBLIC_URL + '/home-plants'} element={<HomePlants />} />
            <Route path={process.env.PUBLIC_URL + '/home-flower-shop'} element={<HomeFlowerShop />} />
            <Route path={process.env.PUBLIC_URL + '/home-flower-shop-two'} element={<HomeFlowerShopTwo />} />
            <Route path={process.env.PUBLIC_URL + '/home-organic-food'} element={<HomeOrganicFood />} />
            <Route
              path={process.env.PUBLIC_URL + '/home-organic-food-two'}
              element={<HomeOrganicFoodTwo />}
            />
            <Route path={process.env.PUBLIC_URL + '/home-onepage-scroll'} element={<HomeOnepageScroll />} />
            <Route path={process.env.PUBLIC_URL + '/home-grid-banner'} element={<HomeGridBanner />} />
            <Route path={process.env.PUBLIC_URL + '/home-auto-parts'} element={<HomeAutoParts />} />
            <Route path={process.env.PUBLIC_URL + '/home-cake-shop'} element={<HomeCakeShop />} />
            <Route path={process.env.PUBLIC_URL + '/home-handmade'} element={<HomeHandmade />} />
            <Route path={process.env.PUBLIC_URL + '/home-pet-food'} element={<HomePetFood />} />
            <Route
              path={process.env.PUBLIC_URL + '/home-medical-equipment'}
              element={<HomeMedicalEquipment />}
            />
            <Route path={process.env.PUBLIC_URL + '/home-christmas'} element={<HomeChristmas />} />
            <Route path={process.env.PUBLIC_URL + '/home-black-friday'} element={<HomeBlackFriday />} />
            <Route
